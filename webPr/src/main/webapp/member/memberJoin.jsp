...
<nav><a href = "./memberLogin.html" style = "text-decoration : none">회원로그인 가기</a></nav>
<section>
	 <article>
		<form name="frm" action="./memberJoinAction.jsp" method="post">
			<table>
				...
				<tr>
					<th>비밀번호확인</th>
					<td><input type="password" name="memberPwd2" maxlength="30" style="width:150px"></td>
				</tr>
				<tr>
					<th id = "name">이름</th>
				...
				<tr>
					<th>이메일</th>
					<td><input type="email" name="memberEmail" maxlength="30" style="width:300px"></td>
				</tr>
				<tr>
					<th>연락처</th>
				...
				<tr>
					<th>생년월일</th>
					<td><input type="number" name="memberBirth" maxlength="8" style="width:100px">예)20240101</td>
				</tr>
				<tr>
					<th>취미</th>
					<td>
					<input type="checkbox" name="memberHobby" maxlength="30"  id = "check1" value = "야구"><label for = "check1">야구</label>
					<input type="checkbox" name="memberHobby" maxlength="30" id = "check2" value = "축구"><label for = "check2">축구</label>
					<input type="checkbox" name="memberHobby" maxlength="30"  id = "check3" value = "농구"><label for = "check3">농구</label>
					</td>
				</tr>
				<tr>
