...
<input type = "checkbox" name = "shoes" value = "30000" onclick = "calc(this);"> 구두 30000원
<input type = "checkbox" name = "bag" value = "80000" onclick = "calc(this);"> 가방 800000원
</form>
